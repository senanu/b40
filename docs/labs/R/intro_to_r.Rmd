...
Below, you will see a gray code 'chunk' that begins and ends with 3 backticks (under the tilde on your keyboard). All of the code you want to execute will need to go in those gray areas. To execute it, you can click the little right-facing green arrow at the top right of the gray box. Go ahead and experiment and make changes directly into the Rmd document. **Do not copy commands into a separate script file.**
