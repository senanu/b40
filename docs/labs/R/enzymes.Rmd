...
The Rmd version of this file is available [here]({{site.url}}/b40/assets/labs/R/enzymes.Rmd). To show this file properly (ie. show the math and figures), you will need to knit it on your own computer (or RStudio.cloud).
...
1. Connect the points using `type='b'`. Again, this is an argument to the `plot()` command and tells R to use **b**oth lines and points. You could use `type='l'` for **l**ines and `type='p'` for **p**oints.
