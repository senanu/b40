...
* __*m*__ The slope. This is given as the second of the coefficients. In this case, it is `r round(coefficients(profs.regression)[2], 4)`.
* __*b*__ The y-intercept. This is conveniently labeled as the (Intercept). In this case it is `r round(coefficients(profs.regression)[1], 4)`
...
$$Y = mX + b$$
$$Y = `r round(coefficients(profs.regression)[2], 4)` X + `r round(coefficients(profs.regression)[1], 4)`$$
