...
1. Use the output from this function to write down the equation of the regression line through *your* data. Type the equation as a comment (following the pound symbol) in the following code chunk.
