...
2. What is the 3-dimensional shape of methane that you drew above?{{site.space0}}
...
1. Use the periodic table above to write down the electronegativity of each of the atoms in the water molecule.
